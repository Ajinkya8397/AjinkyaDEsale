...
public class NewTest59 {
  ...
  public void beforeTest() {
	  ...
	  new SimpleDateFormat("hh-mm-ms-dd-MM-yyyy").format(new Date())+".html");
	  ...
	  extent.setSystemInfo("Enviornment:", "Selenium Automated Testing");
  ...
  public void getResult(ITestResult result) throws IOException
  {
	  ...
	  {
		  logger.log(Status.SKIP, MarkupHelper.createLabel("test method skipped:"+result.getName(),ExtentColor.YELLOW));
	  }
  }
